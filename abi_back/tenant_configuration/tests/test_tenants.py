# Taked from https://github.com/tomturner/django-tenants/blob/master/django_tenants/tests/test_tenants.py
...
from abi_back.tenant_configuration.custom_dts_test_app.models import DummyModel, ModelWithFkToPublicUser
...
class BaseTestCase(DjangoTransactionTestCase):
    """
    ...
    @classmethod
    def setUpClass(cls):
        settings.TENANT_MODEL = 'tenant_configuration.Tenant'
        settings.TENANT_DOMAIN_MODEL = 'tenant_configuration.Domain'
